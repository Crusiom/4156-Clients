<template>
    <el-container v-loading="loading">
      <el-container>
        <el-main style="height: 100vh;width: 100vw; background-image: url('bg.jpg'); background-repeat:no-repeat;background-size:100% 100%;-moz-background-size:100% 100%;">
          <div style="border: #193562 10px solid;margin-left: 25vw; text-align: center; margin-top: 14vh; height:60vh; width: 50vw; background-color: white">
            <div style="color: #193562;font-size: 60px;font-weight: bold;margin-top: 30px">Health Discussion</div>
            <br>
            <div style="color: #9FCBEA;font-size: 25px;">"Share your question and get answers!"</div>
            <br><br>
